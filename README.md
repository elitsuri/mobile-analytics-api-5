...
> Mobile Analytics API: Mobile analytics collection API with event batching and dashboards
...
git clone https://github.com/elitsuri/mobile-analytics-api
cd mobile-analytics-api
